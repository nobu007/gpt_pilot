...
from helpers.agents.TechLead import DEVELOPMENT_PLANNING_STEP, TechLead
...
class TestTechLead:
    def setup_method(self):
        ...
        self.project = Project(
            {"app_id": "test-tech-lead", "name": name, "app_type": ""}, name=name, architecture=[], user_stories=[]
        )

        self.project.set_root_path(
            os.path.abspath(
                os.path.join(os.path.dirname(os.path.abspath(__file__)), "../../../workspace/TestTechLead")
            )
        )
