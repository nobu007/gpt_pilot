...
from database.database import get_app, get_progress_steps, save_app, save_progress
...
from utils.utils import clean_filename, generate_app_data, should_execute_step, step_already_finished
...
class ProductOwner(Agent):
        ...
        if "name" not in self.project.args:
            while True:
                ...
                if len(project_name) <= MAX_PROJECT_NAME_LENGTH:
                    ...
                    print(
                        f"Hold your horses cowboy! Please, give project NAME with max {MAX_PROJECT_NAME_LENGTH} characters."
                    )
    ...
    def get_user_stories(self):
        ...
        self.project.user_stories = self.convo_user_stories.continuous_conversation(
    ...
    def get_user_tasks(self):
        ...
        self.project.user_tasks = self.convo_user_stories.continuous_conversation(
            "user_stories/user_tasks.prompt", {"END_RESPONSE": END_RESPONSE}
        )
