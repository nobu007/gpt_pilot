...
def create_project():
    ...
    project = Project({"app_id": "test-project", "name": "TestProject", "app_type": ""})
...
class TestProject:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                "",
                f"{test_root}/folder1/folder2/server.js",
                "/folder1/folder2",
                f"{test_root}/folder1/folder2/server.js",
            ),
            (
                "",
                f"{test_root}/Folder With Space/server.js",
                "/Folder With Space",
                f"{test_root}/Folder With Space/server.js",
            ),
            ("", "~/folder1/folder2/server.js", "/folder1/folder2", f"{test_root}/folder1/folder2/server.js"),
            ...
            (
                f"{test_root}/folder1",
                f"{test_root}/Folder With Space/",
                "/folder1/Folder With Space",
                f"{test_root}/folder1/Folder With Space/",
            ),
            (f"{test_root}/folder1", "server.js", "/folder1", f"{test_root}/folder1/server.js"),
            ...
            (
                ...
                f"{test_root}/Folder With Space/server.js",
                "/folder1/Folder With Space",
                f"{test_root}/folder1/Folder With Space/server.js",
            ),
            (
                f"{test_root}/folder1",
                "~/folder1/folder2/server.js",
            ...
            (
                ...
                f"{test_root}/Folder With Space/folder1/",
            ),
            (
                f"{test_root}/Folder With Space/",
                f"{test_root}/Folder With Space/",
            ...
            (
                f"{test_root}/Folder With Space/",
                "folder1/folder2",
                "/Folder With Space/folder1/folder2",
                f"{test_root}/Folder With Space/folder1/folder2/",
            ),
            (
                f"{test_root}/Folder With Space/",
                "folder1/folder2/",
            ...
            (
                ...
                "folder1/folder2/server.js",
                "/Folder With Space/folder1/folder2",
                f"{test_root}/Folder With Space/folder1/folder2/server.js",
            ),
            (
                f"{test_root}/Folder With Space/",
                f"{test_root}/folder1/folder2/server.js",
            ...
            (
                ...
                "./folder1/server.js",
                "/Folder With Space/folder1",
                f"{test_root}/Folder With Space/folder1/server.js",
            ),
            ("server.js", "", "/", f"{test_root}/server.js"),
            ("server.js", ".", "/", f"{test_root}/server.js"),
            ...
            (
                "folder1/folder2",
                f"{test_root}/Folder With Space/",
                "/folder1/folder2/Folder With Space",
                f"{test_root}/folder1/folder2/Folder With Space/",
            ),
            ("folder1/folder2", "server.js", "/folder1/folder2", f"{test_root}/folder1/folder2/server.js"),
            ...
            (
                ...
                f"{test_root}/Folder With Space/server.js",
                "/folder1/folder2/Folder With Space",
                f"{test_root}/folder1/folder2/Folder With Space/server.js",
            ),
            (
                "folder1/folder2",
                "~/folder1/folder2/server.js",
            ...
            (
                ...
                ".env",
                "/folder1/folder2",
                f"{test_root}/folder1/folder2/.env",
            ),
            (
                f"{test_root}/folder1/folder2/server.js",
                "~/",
            ...
            (
                ...
                ".env",
                "/Folder With Space",
                f"{test_root}/Folder With Space/.env",
            ),
            (
                f"{test_root}/Folder With Space/server.js",
                "~/",
