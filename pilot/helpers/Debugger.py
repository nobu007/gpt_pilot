...
class Debugger:
    ...
    def debug(
        ...
        self.agent.project.current_task.add_debugging_task(
            self.recursion_layer, command, user_input, issue_description
        )
        ...
        for i in range(MAX_COMMAND_DEBUG_TRIES):
            ...
            if ask_before_debug or i > 0:
                ...
                answer = ask_user(
                    self.agent.project,
                    "Can I start debugging this issue [Y/n/error details]?",
