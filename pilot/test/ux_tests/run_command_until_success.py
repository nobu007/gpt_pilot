...
from helpers.agents import ENVIRONMENT_SETUP_STEP, Developer
...
def run_command_until_success():
    ...
    project.set_root_path(
        os.path.abspath(os.path.join(os.path.dirname(os.path.abspath(__file__)), "../../../workspace/TestDeveloper"))
    )
    ...
    update_file(
        f"{project.root_path}/package.json",
